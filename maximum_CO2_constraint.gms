...
Ref_E            emissions in refference case [tonCO2 per year]          /2843/
Red_E            emissions reduction fraction from ref case [-]          /1/;
...
maxCO2           maximum emissions constraint
...
maxCO2..         Egrid + Em + En =l= Ref_E*(1-Red_E);
...
execute_unload "MAX_CO2_100.gdx"    Pgrid.L Qn.L Qj.L Pw.L Ps.L Pm.L Qm.L Lb.L
