...
Auton            fraction of autonomy of the microgrid                   /0.25/
...
Lbmax            rated energy storage of battery bank [kW]
...
Gm(t,mm)         natural gas hourly consumption by the MTs [kWh]
Gn(t)            natural gas hourly consumtion by the NGB [kWh]
...
eq5(t)           heat balance
eq11a(t,mm)      lower bound of MTs efficiency constraint
eq11b(t,mm)      upper bound of MTs efficiency constraint
...
autonomy         autonomy imposition to the microgrid    ;
...
*autonomy..       sum(t,sum(mm,Pm(t,mm))+Ps(t)+Pw(t)) =g=
*                 Auton*sum(t,dataset(t,'Pl')+Pj(t)+Pd(t));

autonomy..       sum(t,Pgrid(t)) =l= (1-Auton)*sum(t,dataset(t,'Pl')+Pj(t));
...
execute_unload "MG_autonomy_25.gdx"      Pgrid.L Qn.L Qj.L Pw.L Ps.L Pm.L Qm.L
                                         Lb.L Capex.L Opex.L NPC.L y.L Psr.L
                                         Pwr.L Lbmax.L Qjr.L Qnr.L Gn.L Gm.L
                                         Em.L En.L Egrid.L;
